...
(
	...
	heat.exe dir %MASTERBUILDDIR% -cg HarvestedAppFiles -gg -scom -sreg -sfrag -srd -sw5150 -sw5151 -dr APPFOLDER -var var.MASTERBUILDDIR -t KeyPathFix.xsl -out ./Master/AppHarvest.wxs
	heat.exe dir %MASTERDATADIR% -cg HarvestedDataFiles -gg -scom -sreg -sfrag -srd -sw5150 -sw5151 -dr HARVESTDATAFOLDER -var var.MASTERDATADIR -t KeyPathFix.xsl -out ./Master/DataHarvest.wxs
	...
	heat.exe dir %UPDATEBUILDDIR% -cg HarvestedAppFiles -gg -scom -sreg -sfrag -srd -sw5150 -sw5151 -dr APPFOLDER -var var.UPDATEBUILDDIR -t KeyPathFix.xsl -out ./Update/AppHarvest.wxs
	heat.exe dir %UPDATEDATADIR% -cg HarvestedDataFiles -gg -scom -sreg -sfrag -srd -sw5150 -sw5151 -dr HARVESTDATAFOLDER -var var.UPDATEDATADIR -t KeyPathFix.xsl -out ./Update/DataHarvest.wxs
	...
	candle.exe -arch %Arch% -dAppName=%AppName% -dVersionNumber=%PatchVersion% -dProductCode=%PRODUCTIDGUID% -dManufacturer=%Manufacturer% -dSafeManufacturer=%SafeManufacturer% -dPatchBaseline=%Baseline% -dPatchFamily=%Family% patch.wxs
) && (
